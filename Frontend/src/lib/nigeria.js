...
export const lgas = {
  ...
  "Lagos": ["Agege", "Ajeromi Ifelodun", "Alimosho", "Amuwo Odofin", "Apapa", "Badagry", "Epe", "Eti Osa", "Ibeju Lekki", "Ifako Ijaiye", "Ikeja", "Ikorodu", "Kosofe", "Lagos Island", "Lagos Mainland", "Mushin", "Ojo", "Oshodi Isolo", "Shomolu", "Surulere", "Yaba"],
  ...
  "Ondo": ["Akoko North East", "Akoko North West", "Akoko South East", "Akoko South West", "Akure North", "Akure South", "Ese Odo", "Idanre", "Ifedore", "Ilaje", "Ile Oluji", "Irele", "Odigbo", "Okitipupa", "Ondo East", "Ondo West", "Ose", "Owo"],
...
export const ethnicGroups = [
  "Yoruba", "Igbo (Ibo)", "Hausa", "Fulani", "Ibibio", "Tiv", "Ijaw (Izon)",
  "Efik", "Kanuri", "Urhobo", "Edo (Bini)", "Nupe", "Jukun", "Igala",
  "Gbagyi (Gwari)", "Ebira", "Berom", "Esan", "Oron", "Igede", "Anaang",
  "Boki", "Chamba", "Mama", "Mambilla", "Other",
];
